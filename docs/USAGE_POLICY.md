...
This document explains acceptable use, attribution expectations, and project
provenance rules for Zenthril.
...
Attribution should be visible in the main README, documentation, credits/about
screen, or publication references, depending on how the project is reused.
...
- "Fork of Zenthril"
- "Based on Zenthril"
- "Derived from Zenthril by ax1plee11"
...
Do not publish private materials without explicit permission from the project
owner.

## Relationship to the License

This policy explains project expectations and attribution rules. The legal
license terms are defined in the repository `LICENSE` file.

If there is a conflict between informal guidance in this document and the
license text, consult the license and a qualified legal professional.
